             ...
             <tbody>
              <tr>
               <td align="center" valign="middle">
                ...
                <p><span class="subheading" style="font-size: 18px">Upazila: <? echo $pdfdata->upzname; ?>, District: <? echo $pdfdata->distname; ?>, Division: <? echo $pdfdata->diviname; ?></span></p></td>
              </tr>
             </tbody>
            </table>
            <br />
            <img src="<? echo $pdfdata->image; ?>" width="400px" height="300px" />
    ...
    <div style="width:100%; text-align:right;"><? echo $pageno ; ?> 1</div>
        <fieldset>
        	<legend><div id="lgndp">Organization at a glance</div></legend>
                ...
                <div id="inputName"><span id="IName">No. of Households in the Upazila </span><span id="IInput"><? echo number_format($pdfdata->a10,0); ?></span></div>
            ...
            <table width="100%" border="1" align="center" cellspacing="0">
                <tbody>
                  <tr>
                    ...
                    <td width="20%"><div id="tblhdp">Total (No.)</div></td>
                    <td width="20%"><div id="tblhdp">No. of Beds</div></td>
                  </tr>
                  <tr>
                    <td id="tblclm1">No. of Upazila Health Complex</td>
                  ...
                  <tr>
                    <td id="tblclm1">No. of Chest Disease Clinics (TB clinics)</td>
...
<div id="lgndp">
      ...
      <br /><br />
      <div class="lgndp">All ANC Receiptients:  <? echo ($pdfdata->a55+$pdfdata->a56+$pdfdata->a57+$pdfdata->a58+$pdfdata->a59) ; ?></div>            <div class="lgndp">Total Number of Deliveries:  <? echo ($pdfdata->a65+$pdfdata->a66+$pdfdata->a67+$pdfdata->a68+$pdfdata->a69)+($pdfdata->a70+$pdfdata->a71+$pdfdata->a72+$pdfdata->a73+$pdfdata->a74)+($pdfdata->a75+$pdfdata->a76+$pdfdata->a77+$pdfdata->a78+$pdfdata->a79)+($pdfdata->a80+$pdfdata->a81+$pdfdata->a82+$pdfdata->a83+$pdfdata->a84) ; ?></div>
            <div class="lgndp">No. of Maternal Death:  <? echo ($pdfdata->a95+$pdfdata->a96+$pdfdata->a97+$pdfdata->a98+$pdfdata->a99) ; ?></div>
    ...
    <div style="width:100%; text-align:right;"><? echo $pageno ; ?> 7</div>
     ...
     <fieldset>
    <legend>
    <div id="lgndp">Top 10 diseases according to the number of deaths among admitted patients in the UHC during the reporting period</div></legend>
    <table width="100%" border="1" align="center" cellspacing="0">
      <tbody><tr>
        <td height="34" colspan="2" id="tblhdp" style="text-align:right; padding-right:5px;">Total number of Deaths during the reporting period</td>
      ...
      <tr>
        ...
        <td id="tblclm3"><?php echo number_format(($pdfdata->a264/$pdfdata->a246)*100,2); ?></td>
      </tr>
      <tr>
        <td align="center" id="tblclm1">10</td>
    ...
    <table width="100%" border="1" align="center" cellspacing="0">
      <tbody><tr>
        ...
        <tr>
        <td id="tblclm1">Total Patient days in Upazila Health Complex in 365 days (No.)</td>
  ...
  <table width="100%" border="1" cellspacing="0">
      <tbody>
      <tr>
        <td width="31%" rowspan="2" id="tblhdp">Equipment</td>
        <td width="12%" rowspan="2" id="tblhdp">Total (No.)</td>
        <td width="15%" rowspan="2" id="tblhdp">Functional (No.)</td>
        <td colspan="2" id="tblhdp">Non-functional</td>
        <td width="16%" rowspan="2" id="tblclm2">Not Installed (No.)</td>
        </tr>
      <tr>
        <td width="13%" id="tblhdp">Repairable (No.)</td>
        <td width="13%" id="tblhdp">Non-repairable (No.)</td>
        </tr>
      <tr>
      ...
      <tr>
        ...
        <td width="13%" id="tblclm2"><? echo $pdfdata->a584; ?></td>
        <td width="13%" id="tblclm2"><? echo $pdfdata->a585; ?></td>
        <td width="16%" id="tblclm2"><? echo $pdfdata->a586; ?></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td width="13%" id="tblclm2"><? echo $pdfdata->a588; ?></td>
        <td width="13%" id="tblclm2"><? echo $pdfdata->a589; ?></td>
        <td width="16%" id="tblclm2"><? echo $pdfdata->a590; ?></td>
      </tr>
      <tr>
    ...
    <legend><div id="lgndp">Existing equipments at UHC</div></legend>
      ...
      <tr>
        ...
        <td width="13%" id="tblclm2"><? echo $pdfdata->a724; ?></td>
        <td width="12%" id="tblclm2"><? echo $pdfdata->a725; ?></td>
        <td width="13%" id="tblclm2"><? echo $pdfdata->a726; ?></td>
        </tr>
      <tr>
        ...
        <tr>
          ...
          <td width="13%" id="tblclm2"><? echo $pdfdata->a732; ?></td>
          <td width="12%" id="tblclm2"><? echo $pdfdata->a733; ?></td>
          <td width="13%" id="tblclm2"><? echo $pdfdata->a734; ?></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td width="13%" id="tblclm2"><? echo $pdfdata->a748; ?></td>
          <td width="12%" id="tblclm2"><? echo $pdfdata->a749; ?></td>
          <td width="13%" id="tblclm2"><? echo $pdfdata->a750; ?></td>
        </tr>
        <tr>
    ...
    <legend><div id="lgndp">Existing equipments at UHC</div></legend>
      <table width="100%" border="1" cellspacing="0">
        <tr>
        <td width="34%" rowspan="2" id="tblhdp">Equipment</td>
        <td width="13%" rowspan="2" id="tblhdp">Total (No.)</td>
        <td width="13%" rowspan="2" id="tblhdp">Functional (No.)</td>
        <td colspan="2" id="tblhdp">Non-functional</td>
        <td width="14%" rowspan="2" id="tblclm2">Not Installed (No.)</td>
