...
<div class="fullpage">
             ...
             <tbody>
              <tr>
               <td align="center" valign="middle">
                ...
                <span class="subheading"><? echo $pdfdata->orgname; ?></span></p>
                <span class="subheading" style="font-size: 18px">District: <? echo $pdfdata->distname; ?>, Division: <? echo $pdfdata->diviname; ?></span></td>
              </tr>
             </tbody>
            </table>
            <br />
            <img src="../../dghshrm/<? echo $pdfdata->image; ?>" width="400px" />
    ...
    <div class="fullpage">
    	...
    	<fieldset>
            ...
            <div id="prefacefooter"><? echo $pdfdata->a2; ?><br>Civil Surgeon<br><? echo $pdfdata->orgname; ?></div>
     	</fieldset>
    </div>
    ...
    <div style="width:100%; text-align:right;"><? echo $pageno ; ?> 1</div>
        <fieldset>
        	<legend><div id="lgndp">Organization at a glance</div></legend>
                <div id="inputName"><span id="IName">Name of the Civil Surgeon</span><span id="IInput"><? echo $pdfdata->a2; ?></span></div>
                <div id="inputName"><span id="IName">Name of District </span><span id="IInput"><? echo $pdfdata->distname; ?></span>
                </div>
                ...
                <div id="inputName"><span id="IName">GPS location of Civl Surgeon office </span><span id="IInput"> Lati: <? echo number_format($pdfdata->a7,4); ?></span> And <span id="IInput"> Long: <? echo number_format($pdfdata->a8,4); ?></span></div>
                <div id="inputName"><span id="IName">No. of Upazila in the District</span><span id="IInput"><? echo number_format($pdfdata->a835); ?></span></div>
                ...
                <div id="inputName"><span id="IName">Area of District in sq km </span><span id="IInput"><? echo number_format($pdfdata->a12); ?></span></div>
        </fieldset>
      ...
      <fieldset>
          ...
          <table width="100%" border="1" align="center" cellspacing="0">
              <tbody>
                ...
                <tr>
                  <td id="tblclm1">Medical College Hospital</td>
                  <td id="tblclm2"><? echo number_format($pdfdata->a836); ?></td>
                  <td id="tblclm3"><? echo number_format($pdfdata->a837); ?></td>
                  </tr>
                  <tr>
                    <td id="tblclm1">District Hospital</td>
                    <td id="tblclm2"><? echo number_format($pdfdata->a838); ?></td>
                    <td id="tblclm2"><? echo number_format($pdfdata->a839); ?></td>
                  </tr>
                  <tr>
                    <td id="tblclm1">General Hospital</td>
                    <td id="tblclm2"><? echo number_format($pdfdata->a840); ?></td>
                    <td id="tblclm2"><? echo number_format($pdfdata->a841); ?></td>
                  </tr>
                  <tr>
                    <td id="tblclm1">Upazila Health Complexes</td>
                ...
                <tr>
                  <td id="tblclm1">No. of Rural/Urban/Thana Dispensaries</td>
    ...
    <div style="width:100%; text-align:right;"><? echo $pageno ; ?> 3</div>
      	...
      	<fieldset>
            ...
            <div class="lgndp" style="text-align: right">No. of Live Birth:  <?php echo number_format($pdfdata->a33,0);?></div>         
...
<div id="lgndp">
   ...
   <fieldset>
    <legend>
    <div id="lgndp"> No. of OPD &amp; Emergency visits &amp; Deaths at Civil Surgeon Office</div></legend>
    <table width="100%" border="1" align="center" cellspacing="0">
      <tbody><tr>
      ...
      <tr>
        <td id="tblclm1">District Hospital</td>
        <td id="tblclm2" class="bold"><? echo number_format(($pdfdata->a842)+($pdfdata->a843)); ?></td>
        ...
        <td id="tblclm2" class="bold"><? echo number_format(($pdfdata->a845)+($pdfdata->a846)); ?></td>
      ...
      <tr>
        ...
        <td id="tblclm2" class="bold"><?php echo number_format(($pdfdata->a842)+($pdfdata->a843)+($pdfdata->a105)+($pdfdata->a106)+($pdfdata->a129)+($pdfdata->a130)+($pdfdata->a132)+($pdfdata->a133)+($pdfdata->a129)+($pdfdata->a130)+($pdfdata->a126)+($pdfdata->a127)+($pdfdata->a123)+($pdfdata->a124)+($pdfdata->a120)+($pdfdata->a121)+($pdfdata->a117)+($pdfdata->a118)+($pdfdata->a114)+($pdfdata->a115)+($pdfdata->a111)+($pdfdata->a112)+($pdfdata->a108)+($pdfdata->a109)) ?></td>
        <td id="tblclm2"><?php echo number_format($pdfdata->a842+$pdfdata->a105+$pdfdata->a108+$pdfdata->a111+$pdfdata->a114+$pdfdata->a117+$pdfdata->a120+$pdfdata->a123+$pdfdata->a126+$pdfdata->a129+$pdfdata->a132+$pdfdata->a842); ?></td>
        <td id="tblclm2"><?php echo number_format(($pdfdata->a843+$pdfdata->a106+$pdfdata->a109+$pdfdata->a112+$pdfdata->a115+$pdfdata->a118+$pdfdata->a121+$pdfdata->a124+$pdfdata->a127+$pdfdata->a130+$pdfdata->a133)); ?></td>
        <td id="tblclm2"><?php echo number_format($pdfdata->a844+$pdfdata->a107+$pdfdata->a110+$pdfdata->a113+$pdfdata->a116+$pdfdata->a119+$pdfdata->a122+$pdfdata->a125+$pdfdata->a128+$pdfdata->a131+$pdfdata->a134); ?></td>
        <td id="tblclm2" class="bold"><?php echo number_format(($pdfdata->a845)+($pdfdata->a846)+($pdfdata->a135)+($pdfdata->a136)+($pdfdata->a138)+($pdfdata->a139)+($pdfdata->a141)+($pdfdata->a142)+($pdfdata->a144)+($pdfdata->a145)+($pdfdata->a147)+($pdfdata->a148)+($pdfdata->a150)+($pdfdata->a151)+($pdfdata->a153)+($pdfdata->a154)+($pdfdata->a156)+($pdfdata->a157)+($pdfdata->a159)+($pdfdata->a160)+($pdfdata->a162)+($pdfdata->a163)) ?></td>
        <td id="tblclm2"><?php echo number_format($pdfdata->a845+$pdfdata->a135+$pdfdata->a138+$pdfdata->a141+$pdfdata->a144+$pdfdata->a147+$pdfdata->a150+$pdfdata->a153+$pdfdata->a156+$pdfdata->a159+$pdfdata->a162); ?></td>
        <td id="tblclm2"><?php echo number_format($pdfdata->a846+$pdfdata->a136+$pdfdata->a139+$pdfdata->a142+$pdfdata->a145+$pdfdata->a148+$pdfdata->a151+$pdfdata->a154+$pdfdata->a157+$pdfdata->a160+$pdfdata->a163); ?></td>
        <td id="tblclm2"><?php echo number_format($pdfdata->a847+$pdfdata->a137+$pdfdata->a140+$pdfdata->a143+$pdfdata->a146+$pdfdata->a149+$pdfdata->a152+$pdfdata->a155+$pdfdata->a158+$pdfdata->a161+$pdfdata->a164); ?></td>
      </tr>
      </tbody>
    </table>
    </fieldset>
    <fieldset>
        <legend><div id="lgndp">No. of Admissions &amp; Deaths at Civil Surgeon Office</div></legend>
        <table width="100%" border="1" align="center" cellspacing="0">
      <tbody><tr>
        <td width="36%" rowspan="2" id="tblhdp">Health Facility</td>
      ...
      <tr>
        <td id="tblclm1">District Hospital</td>
        <td id="tblclm2" class="bold"><? echo number_format(($pdfdata->a848)+($pdfdata->a849)); ?></td>
        ...
        <td id="tblclm2" class="bold"><? echo number_format(($pdfdata->a851)+($pdfdata->a852)); ?></td>
      ...
      <tr>
        <td id="tblclm1">Total</td>
        <td id="tblclm2" class="bold"><? echo number_format(($pdfdata->a848)+($pdfdata->a849)+($pdfdata->a165)+($pdfdata->a166)+($pdfdata->a168)+($pdfdata->a169)+($pdfdata->a171)+($pdfdata->a172)+($pdfdata->a174)+($pdfdata->a175)+($pdfdata->a177)+($pdfdata->a178)+($pdfdata->a180)+($pdfdata->a181)+($pdfdata->a183)+($pdfdata->a184)+($pdfdata->a186)+($pdfdata->a187)+($pdfdata->a189)+($pdfdata->a190)+($pdfdata->a192)+($pdfdata->a193)); ?></td>
        <td id="tblclm2"><?php echo number_format($pdfdata->a848+$pdfdata->a165+$pdfdata->a168+$pdfdata->a171+$pdfdata->a174+$pdfdata->a177+$pdfdata->a180+$pdfdata->a183+$pdfdata->a186+$pdfdata->a189+$pdfdata->a192); ?></td>
        <td id="tblclm2"><?php echo number_format($pdfdata->a849+$pdfdata->a166+$pdfdata->a169+$pdfdata->a172+$pdfdata->a175+$pdfdata->a178+$pdfdata->a181+$pdfdata->a184+$pdfdata->a187+$pdfdata->a190+$pdfdata->a193); ?></td>
        <td id="tblclm2"><?php echo number_format($pdfdata->a850+$pdfdata->a167+$pdfdata->a170+$pdfdata->a173+$pdfdata->a176+$pdfdata->a179+$pdfdata->a182+$pdfdata->a185+$pdfdata->a188+$pdfdata->a191+$pdfdata->a194); ?></td>
        <td id="tblclm2" class="bold"><?php echo number_format($pdfdata->a851+$pdfdata->a852+$pdfdata->a198+$pdfdata->a199+$pdfdata->a201+$pdfdata->a202+$pdfdata->a204+$pdfdata->a205+$pdfdata->a207+$pdfdata->a208+$pdfdata->a210+$pdfdata->a211+$pdfdata->a213+$pdfdata->a214+$pdfdata->a216+$pdfdata->a217+$pdfdata->a219+$pdfdata->a220+$pdfdata->a222+$pdfdata->a223); ?></td>
        <td id="tblclm2"><?php echo number_format($pdfdata->a851+$pdfdata->a198+$pdfdata->a201+$pdfdata->a204+$pdfdata->a207+$pdfdata->a210+$pdfdata->a213+$pdfdata->a216+$pdfdata->a219+$pdfdata->a222); ?></td>
        <td id="tblclm2"><?php echo number_format($pdfdata->a852+$pdfdata->a199+$pdfdata->a202+$pdfdata->a205+$pdfdata->a208+$pdfdata->a211+$pdfdata->a214+$pdfdata->a217+$pdfdata->a220+$pdfdata->a223); ?></td>
        <td id="tblclm2"><?php echo number_format($pdfdata->a853+$pdfdata->a200+$pdfdata->a203+$pdfdata->a206+$pdfdata->a209+$pdfdata->a212+$pdfdata->a215+$pdfdata->a218+$pdfdata->a221+$pdfdata->a224); ?></td>
      </tr>
      </tbody>
    </table>
    </fieldset>
    ...
    <div style="width:100%; text-align:right;"><? echo $pageno ; ?> 6</div>
     <br>
      <fieldset>
    <legend>
    <div id="lgndp">Top 10 diseases according to the number of patients admitted in the Civil Surgeon Office during the reporting period</div></legend>
    <table width="100%" border="1" align="center" cellspacing="0">
      <tbody><tr>
    ...
    <div style="width:100%; text-align:right;"><? echo $pageno ; ?> 7</div>
     ...
     <fieldset>
    <legend>
    <div id="lgndp">Top 10 diseases according to the number of deaths among admitted patients in the Civil Surgeon Office during the reporting period</div></legend>
    <table width="100%" border="1" align="center" cellspacing="0">
      <tbody><tr>
    ...
    <fieldset>
    <legend>
    <div id="lgndp">Surgeries &amp; Interventions done in the Civil Surgeon Office</div></legend>
    ...
    <fieldset>
    <legend>
    	<div id="lgndp">Existing equipments at Civil Surgeon Office</div></legend>
    	<table width="100%" border="1" cellspacing="0">
          <tr>
