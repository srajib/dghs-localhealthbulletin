...
<div class="fullpage">
    ...
    <div class="fullpage">
    	...
    	<fieldset>
            ...
            Director<br><? echo $pdfdata->orgname; ?></div>
     	</fieldset>
    </div>
    ...
    <div style="width:100%; text-align:right;"><? echo $pageno ; ?> 1</div>
        <fieldset>
        	<legend><div id="lgndp">Organization at a glance</div></legend>
                <div id="inputName"><span id="IName">Name of the Facility </span><span id="IInput"><? echo $pdfdata->upzname; ?></span></div>
                <div id="inputName"><span id="IName">Name of Director </span><span id="IInput"><? echo $pdfdata->a2; ?></span>
                </div>
                ...
                <div id="inputName"><span id="IName">GPS location of Facility </span><span id="IInput"> Lati: <? echo number_format($pdfdata->a7,4); ?></span> And <span id="IInput"> Long: <? echo number_format($pdfdata->a8,4); ?></span></div>                
        </fieldset>
    ...
    <div style="width:100%; text-align:right;"><? echo $pageno ; ?> 2</div>
        <fieldset>
            <legend><div id="lgndp">Existing health facilities in the Year <?php echo ($year-1)?></div></legend>
...
<div id="lgndp">
    ...
    <div style="width:100%; text-align:right;"><? echo $pageno ; ?> 4</div>
    	<fieldset>
    <legend><div id="lgndp"> No. of OPD &amp; Emergency visits &amp; Deaths at <span class="heading">Tertiary Hospital</span></div></legend>
    <table width="100%" border="1" align="center" cellspacing="0">
      <tbody><tr>
      ...
      <tr>
        <td id="tblclm1">Medical College Hospital</td>
        <td id="tblclm2"><? echo number_format(($pdfdata->a842)+($pdfdata->a843)); ?></td>
        ...
        <td id="tblclm2"><? echo number_format(($pdfdata->a845)+($pdfdata->a846)); ?></td>
    ...
    <br>
      ...
      <tr>
        <td id="tblclm1">Medical College Hospital</td>
        <td id="tblclm2"><? echo number_format(($pdfdata->a848)+($pdfdata->a849)); ?></td>
        ...
        <td id="tblclm2"><? echo number_format(($pdfdata->a851)+($pdfdata->a852)); ?></td>
    ...
    <div style="width:100%; text-align:right;"><? echo $pageno ; ?> 5</div>
    	<fieldset>
      	<legend><div id="lgndp">Top 10 diseases according to the number of patients admitted in the <span class="heading">Tertiary Hospital</span> during the reporting period</div></legend>
    <table width="100%" border="1" align="center" cellspacing="0">
      <tbody><tr>
      ...
      <tr>
        ...
        <td id="tblclm2"><?php echo number_format(($pdfdata->a245/$pdfdata->a225)*100,2); ?></td>
   		...
   		<fieldset>
    <legend><div id="lgndp">Top 10 diseases according to the number of deaths among admitted patients in the <span class="heading">Tertiary Hospital</span> during the reporting period</div></legend>
    <table width="100%" border="1" align="center" cellspacing="0">
      <tbody><tr>
    ...
    <div style="width:100%; text-align:right;"><? echo $pageno ; ?> 6</div>
     <br>
   		...
   		<fieldset>
    <legend>
    <div id="lgndp">Utilization of services at <span class="heading">Tertiary Hospital</span></div></legend>
    <table width="100%" border="1" align="center" cellspacing="0">
      <tbody><tr>
      ...
      <tr>
    	...
    	<fieldset>
    <legend><div id="lgndp">Surgeries &amp; Interventions done in the <span class="heading">Tertiary Hospital</span></div></legend>
    ...
    <table width="100%" border="1" align="center" cellspacing="0">
      ...
      <tr>
        ...
        <td id="tblclm2"><? echo round(($pdfdata->a866-($pdfdata->a867+$pdfdata->a868))/($pdfdata->a266)*100,2); ?></td>
      </tr>
    ...
    <td id="tblclm2"><? echo $pdfdata->a410; ?></td>
        ...
        <p style="page-break-before:always"></p><div class="fullpage">
    <div style="width:100%; border="1" text-align:right;"><? echo $pageno ; ?> 8</div>
     <br>
    	<fieldset>
    <legend><div id="lgndp">Existing equipments at Tertiary Hospital</div></legend>
  <table width="100%" border="1" cellspacing="0">
      <tr>
    ...
    <div style="width:100%; text-align:right;"><? echo $pageno ; ?> 9</div>
     <br>
    	<fieldset>
    <legend>
    <div id="lgndp">Existing equipments at Tertiary Hospital</div>
    <table width="100%" border="1" cellspacing="0">
      <tr>
