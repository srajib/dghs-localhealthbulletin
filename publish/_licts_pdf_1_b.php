...
<div class="fullpage">
             ...
             <tbody>
              <tr>
               <td align="center" valign="middle">
                <a href="#"><img src="./publish_files/gov.jpg" height="110px" alt="BD GOV"></a><br>
                <span class="heading">Ministry of Health and Family Welfare (MOHFW)</span><br>
                <span class="subheading">HEALTH BULLETIN <? echo $pdfdata->lhb_year; ?></span><br><span style="color:#000; font-weight: bold;">The data belong to Jan-Dec <? echo ($pdfdata->lhb_year-1); ?></span><br><span class="subheading"><? echo $pdfdata->orgname; ?></span>
               </td>
              </tr>
             </tbody>
            </table>
            <br />
            <img src="<? echo $pdfdata->image; ?>" width="400px" />
    ...
    <div style="width:100%; text-align:right;"><? echo $pageno ; ?> 1</div>
        <fieldset>
        	<legend><div id="lgndp">Organization at a glance</div></legend>
                ...
                <div id="inputName"><span id="IName">Telephone No. </span><span id="IInput"><? echo $pdfdata->a4; ?></span></div>
                <div id="inputName"><span id="IName">FAX No. </span><span id="IInput"><? echo $pdfdata->a5; ?></span></div>
                <div id="inputName"><span id="IName">Mobile No. </span><span id="IInput"><? echo $pdfdata->a3; ?></span></div>
                <div id="inputName"><span id="IName">Email </span><span id="IInput"><? echo $pdfdata->a6; ?></span></div>
                <div id="inputName"><span id="IName">GPS location of UHFPO office </span><span id="IInput"> Lati: <? echo $pdfdata->a7; ?></span> And <span id="IInput"> Long: <? echo $pdfdata->a8; ?></span></div>
                <div id="inputName"><span id="IName">No. of Unions in the Upazila</span><span id="IInput"><? echo $pdfdata->a9; ?></span></div>
                <div id="inputName"><span id="IName">No. of Households in the Upazila </span><span id="IInput"><? echo $pdfdata->a10; ?></span></div>
                <div id="inputName"><span id="IName">No. of Population in the Upazila </span><span id="IInput"><? echo $pdfdata->a11; ?></span></div>
                <div id="inputName"><span id="IName">Area of Upazila in sq km </span><span id="IInput"><? echo $pdfdata->a12; ?></span></div>
        </fieldset>
    ...
    <div style="width:100%; text-align:right;"><? echo $pageno ; ?> 3</div>
        <fieldset>
            <legend><div id="lgndp">Child health and MDG-4 (January-December, <? echo ($year-1) ; ?>)</div></legend>
        ...
        <fieldset>
        <legend><div id="lgndp">Neonatal Mortality Rate (January-December, <? echo ($year-1) ; ?>)</div>
        </legend>
        Neonatal Mortality Rate (NMR) is <? echo ($pdfdata->a35/$pdfdata->a33)*1000; ?> per 1,000 live births.
        </fieldset>
    ...
    <fieldset>
        <legend><div id="lgndp">Maternal health and MDG-5 (January-December, <? echo ($year-1) ; ?>)</div></legend>
          <div style="text-align:center; border:#000 solid 2px; height:400px;">
    ...
    <fieldset>
        <legend><div id="lgndp">Maternal health and MDG-5 (January-December, <? echo ($year-1) ; ?>)</div>
        </legend>
        Maternal Mortality Ratio (MMR) is 
        <? echo ($pdfdata->a36/$pdfdata->a33)*100000; ?> per 100,000 live births.
        <br> &nbsp;
    </fieldset>
    ...
    <div style="width:100%; text-align:right;"><? echo $pageno ; ?> 5</div>
     <br>
    <fieldset>
    <legend><div id="lgndp"> No. of OPD &amp; Emergency visits &amp; Deaths at UHC </div></legend>
    <table width="100%" border="1" align="center" cellspacing="0">
      <tbody><tr>
      ...
      <tr>
        <td id="tblclm1">Upazila Health Complex</td>
        <td id="tblclm2"><? echo ($pdfdata->a105)+($pdfdata->a106); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a105; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a106; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a107; ?></td>
        <td id="tblclm2"><? echo ($pdfdata->a135)+($pdfdata->a136); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a135; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a136; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a137; ?></td>
        </tr>
         <tr>
        <td id="tblclm1">Union Sub-Centres</td>
        <td id="tblclm2"><? echo ($pdfdata->a108)+($pdfdata->a109); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a108; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a109; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a110; ?></td>
        <td id="tblclm2"><? echo ($pdfdata->a138)+($pdfdata->a139); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a138; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a139; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a140; ?></td>
        </tr>
      <tr>
        <td id="tblclm1">Union Health and  Family Welfare Centre (under DGHS)</td>
        <td id="tblclm2"><? echo ($pdfdata->a111)+($pdfdata->a112); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a111; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a112; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a113; ?></td>
        <td id="tblclm2"><? echo ($pdfdata->a141)+($pdfdata->a142); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a141; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a142; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a143; ?></td>
        </tr>
      <tr>
        <td id="tblclm1">Rural Dispensaries</td>
        <td id="tblclm2"><? echo ($pdfdata->a114)+($pdfdata->a115); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a114; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a115; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a116; ?></td>
        <td id="tblclm2"><? echo ($pdfdata->a144)+($pdfdata->a145); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a144; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a145; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a146; ?></td>
        </tr>
      <tr>
        <td id="tblclm1">Community Clinics</td>
        <td id="tblclm2"><? echo ($pdfdata->a117)+($pdfdata->a118); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a117; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a118; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a119; ?></td>
        <td id="tblclm2"><? echo ($pdfdata->a147)+($pdfdata->a148); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a147; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a148; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a149; ?></td>
        </tr>
      <tr>
        <td id="tblclm1">Trauma Centres</td>
        <td id="tblclm2"><? echo ($pdfdata->a120)+($pdfdata->a121); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a120; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a121; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a122; ?></td>
        <td id="tblclm2"><? echo ($pdfdata->a150)+($pdfdata->a151); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a150; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a151; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a152; ?></td>
        </tr>
      <tr>
        <td id="tblclm1">MCWCs</td>
        <td id="tblclm2"><? echo ($pdfdata->a123)+($pdfdata->a124); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a123; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a124; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a125; ?></td>
        <td id="tblclm2"><? echo ($pdfdata->a153)+($pdfdata->a154); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a153; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a154; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a155; ?></td>
        </tr>
      <tr>
        <td id="tblclm1">Chest Disease Clinics  (TB clinics)</td>
        <td id="tblclm2"><? echo ($pdfdata->a126)+($pdfdata->a127); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a126; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a127; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a128; ?></td>
        <td id="tblclm2"><? echo ($pdfdata->a156)+($pdfdata->a157); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a156; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a157; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a158; ?></td>
        </tr>
      <tr>
        <td id="tblclm1">Private Clinics/Facilities</td>
        <td id="tblclm2"><? echo ($pdfdata->a129)+($pdfdata->a130); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a129; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a130; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a131; ?></td>
        <td id="tblclm2"><? echo ($pdfdata->a159)+($pdfdata->a160); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a159; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a160; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a161; ?></td>
        </tr>
      <tr>
        <td id="tblclm1">NGO Clinics/Facilities</td>
        <td id="tblclm2"><? echo ($pdfdata->a132)+($pdfdata->a133); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a132; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a133; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a134; ?></td>
        <td id="tblclm2"><? echo ($pdfdata->a162)+($pdfdata->a163); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a162; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a163; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a164; ?></td>
        </tr>
      </tbody>
    </table>
    </fieldset>
    ...
    <fieldset>
        <legend><div id="lgndp">No. of Admissions &amp; Deaths at UHC</div></legend>
        <table width="100%" border="1" align="center" cellspacing="0">
      <tbody><tr>
        <td width="36%" rowspan="2" id="tblhdp">Health Facility</td>
      ...
      <tr>
        <td id="tblclm1">Upazila Health Complex</td>
        <td id="tblclm2"><? echo ($pdfdata->a165)+($pdfdata->a166); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a165; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a166; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a167; ?></td>
        <td id="tblclm2"><? echo ($pdfdata->a195)+($pdfdata->a196); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a195; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a196; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a197; ?></td>
        </tr>
         <tr>
        <td id="tblclm1">Union Sub-Centres</td>
        <td id="tblclm2"><? echo ($pdfdata->a168)+($pdfdata->a169); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a168; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a169; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a170; ?></td>
        <td id="tblclm2"><? echo ($pdfdata->a198)+($pdfdata->a199); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a198; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a199; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a200; ?></td>
        </tr>
      <tr>
        <td id="tblclm1">Union Health and  Family Welfare Centre (under DGHS)</td>
        <td id="tblclm2"><? echo ($pdfdata->a171)+($pdfdata->a172); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a171; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a172; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a173; ?></td>
        <td id="tblclm2"><? echo ($pdfdata->a201)+($pdfdata->a202); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a201; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a202; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a203; ?></td>
        </tr>
      <tr>
        <td id="tblclm1">Rural Dispensaries</td>
        <td id="tblclm2"><? echo ($pdfdata->a174)+($pdfdata->a175); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a174; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a175; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a176; ?></td>
        <td id="tblclm2"><? echo ($pdfdata->a204)+($pdfdata->a205); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a204; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a205; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a206; ?></td>
        </tr>
      <tr>
        <td id="tblclm1">Community Clinics</td>
        <td id="tblclm2"><? echo ($pdfdata->a177)+($pdfdata->a178); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a177; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a178; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a179; ?></td>
        <td id="tblclm2"><? echo ($pdfdata->a207)+($pdfdata->a208); ?></td>
      ...
      <tr>
        <td id="tblclm1">Trauma Centres</td>
        <td id="tblclm2"><? echo ($pdfdata->a180)+($pdfdata->a181); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a180; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a181; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a182; ?></td>
        <td id="tblclm2"><? echo ($pdfdata->a210)+($pdfdata->a211); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a210; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a211; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a212; ?></td>
        </tr>
      <tr>
        <td id="tblclm1">MCWCs</td>
        <td id="tblclm2"><? echo ($pdfdata->a183)+($pdfdata->a184); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a183; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a184; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a185; ?></td>
        <td id="tblclm2"><? echo ($pdfdata->a213)+($pdfdata->a214); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a213; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a214; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a215; ?></td>
        </tr>
      <tr>
        <td id="tblclm1">Chest Disease Clinics  (TB clinics)</td>
        <td id="tblclm2"><? echo ($pdfdata->a186)+($pdfdata->a187); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a186; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a187; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a188; ?></td>
        <td id="tblclm2"><? echo ($pdfdata->a216)+($pdfdata->a217); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a216; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a217; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a218; ?></td>
        </tr>
      <tr>
        <td id="tblclm1">Private Clinics/Facilities</td>
        <td id="tblclm2"><? echo ($pdfdata->a189)+($pdfdata->a190); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a190; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a191; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a182; ?></td>
        <td id="tblclm2"><? echo ($pdfdata->a219)+($pdfdata->a220); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a219; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a220; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a221; ?></td>
        </tr>
      <tr>
        <td id="tblclm1">NGO Clinics/Facilities</td>
        <td id="tblclm2"><? echo ($pdfdata->a192)+($pdfdata->a193); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a192; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a193; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a194; ?></td>
        <td id="tblclm2"><? echo ($pdfdata->a222)+($pdfdata->a223); ?></td>
        <td id="tblclm2"><? echo $pdfdata->a222; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a223; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a224; ?></td>
        </tr>
      </tbody>
    </table>
    </fieldset>
    ...
    <div style="width:100%; text-align:right;"><? echo $pageno ; ?> 6</div>
     <br>
      <fieldset>
    <legend><div id="lgndp">Top 10 diseases according to the number of patients admitted in the UHC during the reporting period</div></legend>
    <table width="100%" border="1" align="center" cellspacing="0">
      <tbody><tr>
        <td height="34" colspan="2" id="tblhdp">Total number of admitted  patients during the reporting period</td>
        <td colspan="2" id="tblclm3"><?php echo $pdfdata->a225; ?></td>
        </tr>
      <tr>
        <td width="10%" align="center"><div id="tblhdp">Serial No.</div></td>
        <td width="66%"><div id="tblhdp">Disease name</div></td>
        <td width="14%"><div id="tblhdp">No. of cases</div></td>
        <td width="10%"><div id="tblhdp"> % </div></td>
      </tr>
      <tr>
        <td align="center" id="tblclm1">1</td>
        <td id="tblclm2"><? echo $pdfdata->a226; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a227; ?></td>
        <td id="tblclm2"><?php echo ($pdfdata->a227/$pdfdata->a225)*100; ?></td>
        </tr>
      <tr>
        <td align="center" id="tblclm1">2</td>
        <td id="tblclm2"><? echo $pdfdata->a228; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a229; ?></td>
        <td id="tblclm2"><?php echo ($pdfdata->a229/$pdfdata->a225)*100; ?></td>
        </tr>
      <tr>
        <td align="center" id="tblclm1">3</td>
        <td id="tblclm2"><? echo $pdfdata->a230; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a231; ?></td>
        <td id="tblclm2"><?php echo ($pdfdata->a231/$pdfdata->a225)*100; ?></td>
        </tr>
      <tr>
        <td align="center" id="tblclm1">4</td>
        <td id="tblclm2"><? echo $pdfdata->a232; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a233; ?></td>
        <td id="tblclm2"><?php echo ($pdfdata->a233/$pdfdata->a225)*100; ?></td>
        </tr>
      <tr>
        <td align="center" id="tblclm1">5</td>
        <td id="tblclm2"><? echo $pdfdata->a234; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a235; ?></td>
        <td id="tblclm2"><?php echo ($pdfdata->a235/$pdfdata->a225)*100; ?></td>
        </tr>
      <tr>
        <td align="center" id="tblclm1">6</td>
        <td id="tblclm2"><? echo $pdfdata->a236; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a237; ?></td>
        <td id="tblclm2"><?php echo ($pdfdata->a237/$pdfdata->a225)*100; ?></td>
        </tr>
      <tr>
        <td align="center" id="tblclm1">7</td>
        <td id="tblclm2"><? echo $pdfdata->a238; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a239; ?></td>
        <td id="tblclm2"><?php echo ($pdfdata->a239/$pdfdata->a225)*100; ?></td>
        </tr>
      <tr>
        <td align="center" id="tblclm1">8</td>
        <td id="tblclm2"><? echo $pdfdata->a240; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a241; ?></td>
        <td id="tblclm2"><?php echo ($pdfdata->a241/$pdfdata->a225)*100; ?></td>
        </tr>
      <tr>
        <td align="center" id="tblclm1">9</td>
        <td id="tblclm2"><? echo $pdfdata->a242; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a243; ?></td>
        <td id="tblclm2"><?php echo ($pdfdata->a243/$pdfdata->a225)*100; ?></td>
        </tr>
      <tr>
        <td align="center" id="tblclm1">10</td>
        <td id="tblclm2"><? echo $pdfdata->a244; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a245; ?></td>
        <td id="tblclm2"><?php echo ($pdfdata->a245/$pdfdata->a225)*100; ?></td>
        </tr>
    </tbody></table>
    </fieldset>
    <br>
    ...
    <div style="width:100%; text-align:right;"><? echo $pageno ; ?> 7</div>
     <br>
     <fieldset>
    <legend><div id="lgndp">Top 10 diseases according to the number of deaths among admitted patients in the UHC during the reporting period</div></legend>
    <table width="100%" border="1" align="center" cellspacing="0">
      <tbody><tr>
      ...
      <tr>
        <td width="10%" align="center"><div id="tblhdp">Serial No.</div></td>
        <td width="66%"><div id="tblhdp">Disease name (Four Digit ICD-10 code)</div></td>
        <td width="14%"><div id="tblhdp">No. of cases</div></td>
        <td width="10%"><div id="tblhdp"> % </div></td>
      </tr>
      <tr>
        <td align="center" id="tblclm1">1</td>
        <td id="tblclm2"><? echo $pdfdata->a247; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a248; ?></td>
        <td id="tblclm3"><?php echo ($pdfdata->a248/$pdfdata->a246)*100; ?></td>
      </tr>
      <tr>
        <td align="center" id="tblclm1">2</td>
        <td id="tblclm2"><? echo $pdfdata->a249; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a250; ?></td>
        <td id="tblclm3"><?php echo ($pdfdata->a250/$pdfdata->a246)*100; ?></td>
      </tr>
      <tr>
        <td align="center" id="tblclm1">3</td>
        <td id="tblclm2"><? echo $pdfdata->a251; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a252; ?></td>
        <td id="tblclm3"><?php echo ($pdfdata->a252/$pdfdata->a246)*100; ?></td>
      </tr>
      <tr>
        <td align="center" id="tblclm1">4</td>
        <td id="tblclm2"><? echo $pdfdata->a253; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a254; ?></td>
        <td id="tblclm3"><?php echo ($pdfdata->a254/$pdfdata->a246)*100; ?></td>
      </tr>
      <tr>
        <td align="center" id="tblclm1">5</td>
        <td id="tblclm2"><? echo $pdfdata->a255; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a256; ?></td>
        <td id="tblclm3"><?php echo ($pdfdata->a256/$pdfdata->a246)*100; ?></td>
      </tr>
      <tr>
        <td align="center" id="tblclm1">6</td>
        <td id="tblclm2"><? echo $pdfdata->a257; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a258; ?></td>
        <td id="tblclm3"><?php echo ($pdfdata->a258/$pdfdata->a246)*100; ?></td>
      </tr>
      <tr>
        <td align="center" id="tblclm1">7</td>
        <td id="tblclm2"><? echo $pdfdata->a259; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a260; ?></td>
        <td id="tblclm3"><?php echo ($pdfdata->a260/$pdfdata->a246)*100; ?></td>
      </tr>
      <tr>
        <td align="center" id="tblclm1">8</td>
        <td id="tblclm2"><? echo $pdfdata->a261; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a262; ?></td>
        <td id="tblclm3"><?php echo ($pdfdata->a262/$pdfdata->a246)*100; ?></td>
      </tr>
      <tr>
        <td align="center" id="tblclm1">9</td>
        <td id="tblclm2"><? echo $pdfdata->a263; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a264; ?></td>
        <td id="tblclm3"><?php echo ($pdfdata->a64/$pdfdata->a246)*100; ?></td>
      </tr>
      <tr>
        <td align="center" id="tblclm1">10</td>
        <td id="tblclm2"><? echo $pdfdata->a265; ?></td>
        <td id="tblclm2"><? echo $pdfdata->a266; ?></td>
        <td id="tblclm3"><?php echo ($pdfdata->a266/$pdfdata->a246)*100; ?></td>
        </tr>
    </tbody></table>
    </fieldset>
    <br>
    ...
    <br>
     ...
     <br>
    <fieldset>
    <legend><div id="lgndp">Surgeries &amp; Interventions done in the Upazila Hospital</div></legend>
    ...
    <table width="100%" border="1" align="center" cellspacing="0">
      ...
      <tr>
        ...
        <td id="tblclm2"><? echo ($pdfdata->a271-($pdfdata->a272+$pdfdata->a273))/($pdfdata->a271)*100; ?>  </td>
      </tr>
      <tr>
        ...
        <td id="tblclm2"><? echo round(($pdfdata->a274-($pdfdata->a275+$pdfdata->a276))/($pdfdata->a274)*100,2); ?></td>
        </tr>
      <tr>
        ...
        <td id="tblclm2"><? echo round(($pdfdata->a277-($pdfdata->a278+$pdfdata->a279))/($pdfdata->a277)*100,2); ?></td>
      </tr>
      <tr>
        ...
        <td id="tblclm2"><? echo round(($pdfdata->a280-($pdfdata->a281+$pdfdata->a282))/($pdfdata->a280)*100,2); ?></td>
        </tr>
      <tr>
        ...
        <td id="tblclm2"><? echo round(($pdfdata->a283-($pdfdata->a284+$pdfdata->a285))/($pdfdata->a283)*100,2); ?></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="tblclm2"><? echo round(($pdfdata->a286-($pdfdata->a287+$pdfdata->a288))/($pdfdata->a286)*100,2); ?></td>
      </tr>
      <tr>
        <td id="tblclm2">Non Doctor</td>
        ...
        <td id="tblclm2"><? echo round(($pdfdata->a289-($pdfdata->a290+$pdfdata->a291))/($pdfdata->a289)*100,2); ?></td>
        </tr>
      <tr>
        <td colspan="2" id="tblclm1">Class II</td>
        ...
        <td id="tblclm2"><? echo round(($pdfdata->a292-($pdfdata->a293+$pdfdata->a294))/($pdfdata->a292)*100,2); ?></td>
      </tr>
      <tr>
        <td colspan="2" id="tblclm1">Class III</td>
        ...
        <td id="tblclm2"><? echo round(($pdfdata->a295-($pdfdata->a296+$pdfdata->a297))/($pdfdata->a295)*100,2); ?></td>
        </tr>
      <tr>
        <td colspan="2" id="tblclm1">Class IV</td>
        ...
        <td id="tblclm2"><? echo round(($pdfdata->a298-($pdfdata->a299+$pdfdata->a300))/($pdfdata->a298)*100,2); ?></td>
      </tr>
      <tr>
        <th colspan="7" id="tblhdp">Rural Dispensaries</th>
      </tr>
      <tr>
        <td width="8%" rowspan="2" id="tblclm1">Class I</td>
        <td width="10%" id="tblclm2">Doctor</td>
        ...
        <td id="tblclm2"><? echo round(($pdfdata->a301-($pdfdata->a302+$pdfdata->a303))/($pdfdata->a301)*100,2); ?></td>
      </tr>
      <tr>
        <td id="tblclm2">Non Doctor</td>
        ...
        <td id="tblclm2"><? echo round(($pdfdata->a304-($pdfdata->a305+$pdfdata->a306))/($pdfdata->a304)*100,2); ?></td>
        </tr>
      <tr>
        <td colspan="2" id="tblclm1">Class II</td>
        ...
        <td id="tblclm2"><? echo ($pdfdata->a307-($pdfdata->a308+$pdfdata->a309)); ?></td>
            <td id="tblclm2"><? echo round(($pdfdata->a307-($pdfdata->a308+$pdfdata->a309))/($pdfdata->a307)*100,2); ?></td>
      </tr>
      <tr>
        <td colspan="2" id="tblclm1">Class III</td>
        ...
        <td id="tblclm2"><? echo round(($pdfdata->a310-($pdfdata->a311+$pdfdata->a312))/($pdfdata->a310)*100,2); ?></td>
        </tr>
      <tr>
        <td colspan="2" id="tblclm1">Class IV</td>
        ...
        <td id="tblclm2"><? echo round(($pdfdata->a313-($pdfdata->a314+$pdfdata->a315))/($pdfdata->a313)*100,2); ?></td>
      </tr>
     <th colspan="7" id="tblhdp">Community Clinics</th>
      ...
      <tr>
        ...
        <td id="tblclm2"><? echo round(($pdfdata->a316-($pdfdata->a317+$pdfdata->a318))/($pdfdata->a316)*100,2); ?></td>
      </tr>
      <tr>
        <td id="tblclm2">Non Doctor</td>
        ...
        <td id="tblclm2"><? echo round(($pdfdata->a319-($pdfdata->a320+$pdfdata->a321))/($pdfdata->a319)*100,2); ?></td>
        </tr>
      <tr>
        <td colspan="2" id="tblclm1">Class II</td>
        ...
        <td id="tblclm2"><? echo ($pdfdata->a322-($pdfdata->a323+$pdfdata->a324)); ?></td>
            <td id="tblclm2"><? echo round(($pdfdata->a322-($pdfdata->a323+$pdfdata->a324))/($pdfdata->a322)*100,2); ?></td>
      </tr>
      <tr>
        <td colspan="2" id="tblclm1">Class III</td>
        ...
        <td id="tblclm2"><? echo round(($pdfdata->a325-($pdfdata->a326+$pdfdata->a327))/($pdfdata->a325)*100,2); ?></td>
        </tr>
      <tr>
        <td colspan="2" id="tblclm1">Class IV</td>
        ...
        <td id="tblclm2"><? echo round(($pdfdata->a328-($pdfdata->a329+$pdfdata->a330))/($pdfdata->a328)*100,2); ?></td>
      </tr>
    </tbody></table>
    </fieldset>
    <br>&nbsp;
    ...
    <table width="100%" border="1" align="center" cellspacing="0">
      ...
      <tr>
        ...
        <td id="tblclm2"><? echo round(($pdfdata->a331-($pdfdata->a332+$pdfdata->a333))/($pdfdata->a331)*100,2); ?></td>
      </tr>
      <tr>
        <td id="tblclm2">Non Doctor</td>
        ...
        <td id="tblclm2"><? echo round(($pdfdata->a334-($pdfdata->a335+$pdfdata->a336))/($pdfdata->a334)*100,2); ?></td>
        </tr>
      <tr>
        <td colspan="2" id="tblclm1">Class II</td>
        ...
        <td id="tblclm2"><? echo ($pdfdata->a337-($pdfdata->a338+$pdfdata->a339)); ?></td>
            <td id="tblclm2"><? echo round(($pdfdata->a337-($pdfdata->a338+$pdfdata->a339))/($pdfdata->a337)*100,2); ?></td>
      </tr>
      <tr>
        <td colspan="2" id="tblclm1">Class III</td>
        ...
        <td id="tblclm2"><? echo round(($pdfdata->a340-($pdfdata->a341+$pdfdata->a342))/($pdfdata->a340)*100,2); ?></td>
        </tr>
      <tr>
        <td colspan="2" id="tblclm1">Class IV</td>
        ...
        <td id="tblclm2"><? echo round(($pdfdata->a343-($pdfdata->a344+$pdfdata->a345))/($pdfdata->a343)*100,2); ?></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="tblclm2"><? echo round(($pdfdata->a346-($pdfdata->a347+$pdfdata->a348))/($pdfdata->a346)*100,2); ?></td>
      </tr>
      <tr>
        <td id="tblclm2">Non Doctor</td>
        ...
        <td id="tblclm2"><? echo round(($pdfdata->a349-($pdfdata->a350+$pdfdata->a351))/($pdfdata->a349)*100,2); ?></td>
        </tr>
      <tr>
        <td colspan="2" id="tblclm1">Class II</td>
        ...
        <td id="tblclm2"><? echo ($pdfdata->a352-($pdfdata->a353+$pdfdata->a354)); ?></td>
            <td id="tblclm2"><? echo round(($pdfdata->a352-($pdfdata->a353+$pdfdata->a354))/($pdfdata->a352)*100,2); ?></td>
      </tr>
      <tr>
        <td colspan="2" id="tblclm1">Class III</td>
        ...
        <td id="tblclm2"><? echo round(($pdfdata->a355-($pdfdata->a356+$pdfdata->a357))/($pdfdata->a355)*100,2); ?></td>
        </tr>
      <tr>
        <td colspan="2" id="tblclm1">Class IV</td>
        ...
        <td id="tblclm2"><? echo round(($pdfdata->a358-($pdfdata->a359+$pdfdata->a360))/($pdfdata->a358)*100,2); ?></td>
      </tr>
    </tbody></table>
    </fieldset>
    <br>&nbsp;
    ...
    <div style="width:100%; text-align:right;"><? echo $pageno ; ?> 13</div>
     <br>
    <fieldset>
    <legend><div id="lgndp">Existing equipments at UHC</div></legend>
    <table width="100%" border="1" cellspacing="0">
      <tr>
  ...
  <table width="100%" border="1" cellspacing="0">
    ...
    <p style="page-break-before:always"></p>
    <div class="fullpage">
    <div style="width:100%; text-align:right;"><? echo $pageno ; ?> 19</div>
     <br>
    <fieldset>
    <legend>
