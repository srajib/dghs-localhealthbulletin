           ...
           <div id="contentwrapper">
                <div class="main_content">
                  <?php include "_nav.php"; ?>
					<div class="row-fluid">
						<div class="span12">               	                    
							<h3 class="heading">Data Entry Form for Sadar Upazila Health Office <?php echo $msg; ?>
                            </h3>
                           	<div class="tabbable tabs-left">
								<ul class="nav nav-tabs">
                                    ...
                                    <li><a href="#page_9" data-toggle="tab" class="pop_over" data-original-title="Surgeries & Interventions done in the Sadar Upazila Health Office" data-placement="right">Page 9</a></li>
									<li><a href="#page_10" data-toggle="tab" class="pop_over" data-original-title="Class wise Manpower in the Sadar Upazila Health Office" data-placement="right">Page 10</a></li>
									...
									<li><a href="#page_12" data-toggle="tab" class="pop_over" data-original-title="Existing equipments at Sadar Upazila Health Office" data-placement="right">Page 12</a></li>                                    																																																									 									<li><a href="#page_13" data-toggle="tab" class="pop_over" data-original-title="Additional Information" data-placement="right">Page 13</a></li>
                                        ...
                                        <div class="span11 form-horizontal well">
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <textarea name="a1" id="txtarea_limit_chars" cols="30" rows="5" class="span10" placeholder="Maximum 2000 characters"><? echo $viewdata->a1; ?></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
                                                        <label class="control-label">Name of UHFPO</label>
                                                        <div class="controls">
                                                    ...
                                                    <div class="control-group">
                                                        <label class="control-label">GPS Location of UHFPO Office</label>
                                                        <div class="controls">
                                                    ...
                                                    <div class="control-group">
                                                        <label class="control-label">Area of Upazila in Sq.Km.</label>
                                                        <div class="controls">
                                    ...
                                    <div class="tab-pane" id="page_4">
										...
										<p class="f_legend">Maternal health &amp; MDG-5 (Year <? echo ($openyear-1); ?>) </p>	
                                          <table class="table table-striped table-bordered">
                                              ...
                                              <tr>
                                               	  <td>No.  of 1st ANC recipients (at least 1) </td>
                                              ...
                                              <tr>
                                                <td>No.  of 4th ANC recipients (at least 4)</td>
                                              ...
                                              <!--<tr>
                                               	  <td>Total No. of deliveries in the Upazila </td>
                                              ...
                                              <tr>
                                                  ...
                                                  <td colspan="6" align="center" valign="middle"><input value="<? echo $viewdata->a100; ?>" name="a100" type="text" class="onlynumber span12" id="a100" onchange="doMath('a100','a101','a102','a103','a104','a100_104')" /></td>
                                              </tr>
                                          </table>
                                     <!--- <table class="table table-striped table-bordered">
                                              <thead>
                                              ...
                                              <tr>
                                               	  <td>Valid TT5 Coverage (%) </td>
                                                  <td><input value="<? echo $viewdata->a100; ?>" name="a100" type="text" class="onlynumber span12" id="a100" onchange="doMath('a100','a101','a102','a103','a104','a100_104')" /></td>
                                                  <td><input value="<? echo $viewdata->a101; ?>" name="a101" type="text" class="onlynumber span12" id="a101" onchange="doMath('a100','a101','a102','a103','a104','a100_104')" /></td>
                                                  <td><input value="<? echo $viewdata->a102; ?>" name="a102" type="text" class="onlynumber span12" id="a102" onchange="doMath('a100','a101','a102','a103','a104','a100_104')" /></td>
                                                  <td><input value="<? echo $viewdata->a103; ?>" name="a103" type="text" class="onlynumber span12" id="a103" onchange="doMath('a100','a101','a102','a103','a104','a100_104')" /></td>
                                                  <td><input value="<? echo $viewdata->a104; ?>" name="a104" type="text" class="onlynumber span12" id="a104" /></td>
                                                  <td><span id="a100_104"></span></td>
                                              </tr>
                                          </table> ----->
                                		</div>
										</p>
...
<tr>
                                     ...
                                     <!--- <table class="table table-striped table-bordered">
                                              ...
                                              <tr>
                                               	  <td>Union Health &amp; Family Welfare Centers </td>
                                                  <td><input value="<? echo $viewdata->a111; ?>" name="a111" type="text" class="onlynumber span12" id="a111" /></td>
                                                  <td><input value="<? echo $viewdata->a112; ?>" name="a112" type="text" class="onlynumber span12" id="a112" /></td>
                                                  <td><input value="<? echo $viewdata->a113; ?>" name="a113" type="text" class="onlynumber span12" id="a113" /></td>
                                              </tr>
                                              ...
                                              <tr>
                                               	  <td>Chest Disease Clinics (TB Clinics) </td>
                                                  <td><input value="<? echo $viewdata->a126; ?>" name="a126" type="text" class="onlynumber span12" id="a126" /></td>
                                                  <td><input value="<? echo $viewdata->a127; ?>" name="a127" type="text" class="onlynumber span12" id="a127" /></td>
                                                  <td><input value="<? echo $viewdata->a128; ?>" name="a128" type="text" class="onlynumber span12" id="a128" /></td>
                                              </tr>
...
<tr>
                         ...
                         Not applicable for Sadar Upazila Health Office. Please go to next page.
						</div>
                                         <!---- <table class="table table-striped table-bordered">
                                              <thead>
                                                  <tr>
...
<p>The classification of major or minor for each proposed surgical procedure will be determined by the IACUC committee.</p>
                          ...
                          <tr>
                                                    <th colspan="5">UHC/Sadar Upazila Health Office</th>
                                                  </tr>
                                              </thead>
                                              <tr>
                                               	  <td rowspan="2">Class I</td>
                                               	  <td>Doctor</td>
                                                	<td><input value="<? echo $viewdata->a271; ?>" name="a271" type="text" class="span12 onlynumber" id="a189" /></td>
                                                	<td><input value="<? echo $viewdata->a272; ?>" name="a272" type="text" class="span12 onlynumber" id="a190" /></td>
                                                  <td><input value="<? echo $viewdata->a273; ?>" name="a273" type="text" class="span12 onlynumber" id="a191" /></td>
                                              </tr>
                                              <tr>
                                                <td>Non-Doctor</td>
                                                <td><input value="<? echo $viewdata->a274; ?>" name="a274" type="text" class="span12 onlynumber" id="a192" /></td>
                                                <td><input value="<? echo $viewdata->a275; ?>" name="a275" type="text" class="span12 onlynumber" id="a193" /></td>
                                                <td><input value="<? echo $viewdata->a276; ?>" name="a276" type="text" class="span12 onlynumber" id="a194" /></td>
                                              </tr>
                                              <tr>
                                               	  <td colspan="2">Class II</td>
                                                	<td><input value="<? echo $viewdata->a277; ?>" name="a277" type="text" class="span12 onlynumber" id="a195" /></td>
                                                	<td><input value="<? echo $viewdata->a278; ?>" name="a278" type="text" class="span12 onlynumber" id="a196" /></td>
                                                  <td><input value="<? echo $viewdata->a279; ?>" name="a279" type="text" class="span12 onlynumber" id="a197" /></td>
                                              </tr>
                                              <tr>
                                               	  <td colspan="2">Class III</td>
                                                	<td><input value="<? echo $viewdata->a280; ?>" name="a280" type="text" class="span12 onlynumber" id="a198" /></td>
                                                	<td><input value="<? echo $viewdata->a281; ?>" name="a281" type="text" class="span12 onlynumber" id="a199" /></td>
                                                  <td><input value="<? echo $viewdata->a282; ?>" name="a282" type="text" class="span12 onlynumber" id="a200" /></td>
                                              </tr>
                                              <tr>
                                               	  <td colspan="2">Class IV</td>
                                                	<td><input value="<? echo $viewdata->a283; ?>" name="a283" type="text" class="span12 onlynumber" id="a201" /></td>
                                                	<td><input value="<? echo $viewdata->a284; ?>" name="a284" type="text" class="span12 onlynumber" id="a202" /></td>
                                                  <td><input value="<? echo $viewdata->a285; ?>" name="a285" type="text" class="span12 onlynumber" id="a203" /></td>
                                              </tr>
                                          </table>
                               		  </div>
                                      <div class="span11 form-horizontal well">
										...
										<p class="f_legend">
                                        	Status of Human Resources (Class wise)
                                            	<span style="float: right" class="input-append date dp2" id="dp3" data-date-format="yyyy/mm/dd">Reporting date 
                                            	<input id="a829" name="a829" class="span6" type="text" readonly value="<? echo $viewdata->a829; ?>" />
                                                	<span class="add-on">
                                                    	<i class="splashy-calendar_day"></i>
                                                	</span>
                                                </span>                                             
                                          ...
                                          <table class="table table-striped table-bordered">
                                            ...
                                            <tr>
                                              ...
                                              <th>Female</th>
                                                  ...
                                                  <tr>
                                                    <th colspan="5">Union Health &amp; Family Welfare Center (under DGHS)</th>
                                                  </tr>
                                              </thead>
                                              <tr>
                                               	  <td rowspan="2">Class I</td>
                                               	  <td>Doctor</td>
                                                	<td><input value="<? echo $viewdata->a286; ?>" name="a286" type="text" class="span12 onlynumber" id="a189" /></td>
                                                	<td><input value="<? echo $viewdata->a287; ?>" name="a287" type="text" class="span12 onlynumber" id="a190" /></td>
                                                  <td><input value="<? echo $viewdata->a288; ?>" name="a288" type="text" class="span12 onlynumber" id="a191" /></td>
                                              </tr>
                                              <tr>
                                                <td>Non-Doctor</td>
                                                <td><input value="<? echo $viewdata->a289; ?>" name="a289" type="text" class="span12 onlynumber" id="a192" /></td>
                                                <td><input value="<? echo $viewdata->a290; ?>" name="a290" type="text" class="span12 onlynumber" id="a193" /></td>
                                                <td><input value="<? echo $viewdata->a291; ?>" name="a291" type="text" class="span12 onlynumber" id="a194" /></td>
                                              </tr>
                                              <tr>
                                               	  <td colspan="2">Class II</td>
                                                	<td><input value="<? echo $viewdata->a292; ?>" name="a292" type="text" class="span12 onlynumber" id="a195" /></td>
                                                	<td><input value="<? echo $viewdata->a293; ?>" name="a293" type="text" class="span12 onlynumber" id="a196" /></td>
                                                  <td><input value="<? echo $viewdata->a294; ?>" name="a294" type="text" class="span12 onlynumber" id="a197" /></td>
                                              </tr>
                                              <tr>
                                               	  <td colspan="2">Class III</td>
                                                	<td><input value="<? echo $viewdata->a295; ?>" name="a295" type="text" class="span12 onlynumber" id="a198" /></td>
                                                	<td><input value="<? echo $viewdata->a296; ?>" name="a296" type="text" class="span12 onlynumber" id="a199" /></td>
                                                  <td><input value="<? echo $viewdata->a297; ?>" name="a297" type="text" class="span12 onlynumber" id="a200" /></td>
                                              </tr>
                                              <tr>
                                               	  <td colspan="2">Class IV</td>
                                                	<td><input value="<? echo $viewdata->a298; ?>" name="a298" type="text" class="span12 onlynumber" id="a201" /></td>
                                                	<td><input value="<? echo $viewdata->a299; ?>" name="a299" type="text" class="span12 onlynumber" id="a202" /></td>
                                                  <td><input value="<? echo $viewdata->a300; ?>" name="a300" type="text" class="span12 onlynumber" id="a203" /></td>
                                              </tr>
                                          </table>
                               		  </div>
                                      <div class="span11 form-horizontal well">
										...
										<p class="f_legend">
                                        	Status of Human Resources (Class wise)
                                            	<span style="float: right" class="input-append date dp2" id="dp2" data-date-format="yyyy/mm/dd">Reporting date 
                                            	<input id="a830" name="a830" class="span6" type="text" readonly value="<? echo $viewdata->a830; ?>" />
                                                	<span class="add-on">
                                                    	<i class="splashy-calendar_day"></i>
                                                	</span>
                                                </span>                                             
                                          ...
                                          <table class="table table-striped table-bordered">
                                            ...
                                            <tr>
                                              ...
                                              <th>Female</th>
                                                  ...
                                                  <tr>
                                                    <th colspan="5">Rural Dispensaries</th>
                                                  </tr>
                                              </thead>
                                              <tr>
                                               	  <td rowspan="2">Class I</td>
                                               	  <td>Doctor</td>
                                                	<td><input value="<? echo $viewdata->a301; ?>" name="a301" type="text" class="span12 onlynumber" id="a189" /></td>
                                                	<td><input value="<? echo $viewdata->a302; ?>" name="a302" type="text" class="span12 onlynumber" id="a190" /></td>
                                                  <td><input value="<? echo $viewdata->a303; ?>" name="a303" type="text" class="span12 onlynumber" id="a191" /></td>
                                              </tr>
                                              <tr>
                                                <td>Non-Doctor</td>
                                                <td><input value="<? echo $viewdata->a304; ?>" name="a304" type="text" class="span12 onlynumber" id="a192" /></td>
                                                <td><input value="<? echo $viewdata->a305; ?>" name="a305" type="text" class="span12 onlynumber" id="a193" /></td>
                                                <td><input value="<? echo $viewdata->a306; ?>" name="a306" type="text" class="span12 onlynumber" id="a194" /></td>
                                              </tr>
                                              <tr>
                                               	  <td colspan="2">Class II</td>
                                                	<td><input value="<? echo $viewdata->a307; ?>" name="a307" type="text" class="span12 onlynumber" id="a195" /></td>
                                                	<td><input value="<? echo $viewdata->a308; ?>" name="a308" type="text" class="span12 onlynumber" id="a196" /></td>
                                                  <td><input value="<? echo $viewdata->a309; ?>" name="a309" type="text" class="span12 onlynumber" id="a197" /></td>
                                              </tr>
                                              <tr>
                                               	  <td colspan="2">Class III</td>
                                                	<td><input value="<? echo $viewdata->a310; ?>" name="a310" type="text" class="span12 onlynumber" id="a198" /></td>
                                                	<td><input value="<? echo $viewdata->a311; ?>" name="a311" type="text" class="span12 onlynumber" id="a199" /></td>
                                                  <td><input value="<? echo $viewdata->a312; ?>" name="a312" type="text" class="span12 onlynumber" id="a200" /></td>
                                              </tr>
                                              <tr>
                                               	  <td colspan="2">Class IV</td>
                                                	<td><input value="<? echo $viewdata->a313; ?>" name="a313" type="text" class="span12 onlynumber" id="a201" /></td>
                                                	<td><input value="<? echo $viewdata->a314; ?>" name="a314" type="text" class="span12 onlynumber" id="a202" /></td>
                                                  <td><input value="<? echo $viewdata->a315; ?>" name="a315" type="text" class="span12 onlynumber" id="a203" /></td>
                                              </tr>
                                          </table>
                               		  </div>
                                      <div class="span11 form-horizontal well">
										...
										<p class="f_legend">
                                        	Status of Human Resources (Class wise)
                                            	<span style="float: right" class="input-append date dp2" data-date-format="yyyy/mm/dd">Reporting date 
                                            	<input id="a831" name="a831" class="span6" type="text" readonly value="<? echo $viewdata->a831; ?>" />
                                                	<span class="add-on">
                                                    	<i class="splashy-calendar_day"></i>
                                                	</span>
                                                </span>                                             
                                          ...
                                          <table class="table table-striped table-bordered">
                                            ...
                                            <tr>
                                              ...
                                              <th>Female</th>
                                                  ...
                                                  <tr>
                                                    <th colspan="5">Community Clinics</th>
                                                  </tr>
                                              </thead>
                                              <tr>
                                               	  <td rowspan="2">Class I</td>
                                               	  <td>Doctor</td>
                                                	<td><input value="<? echo $viewdata->a316; ?>" name="a316" type="text" class="span12 onlynumber" id="a189" /></td>
                                                	<td><input value="<? echo $viewdata->a317; ?>" name="a317" type="text" class="span12 onlynumber" id="a190" /></td>
                                                  <td><input value="<? echo $viewdata->a318; ?>" name="a318" type="text" class="span12 onlynumber" id="a191" /></td>
                                              </tr>
                                              <tr>
                                                <td>Non-Doctor</td>
                                                <td><input value="<? echo $viewdata->a319; ?>" name="a319" type="text" class="span12 onlynumber" id="a192" /></td>
                                                <td><input value="<? echo $viewdata->a320; ?>" name="a320" type="text" class="span12 onlynumber" id="a193" /></td>
                                                <td><input value="<? echo $viewdata->a321; ?>" name="a321" type="text" class="span12 onlynumber" id="a194" /></td>
                                              </tr>
                                              <tr>
                                               	  <td colspan="2">Class II</td>
                                                	<td><input value="<? echo $viewdata->a322; ?>" name="a322" type="text" class="span12 onlynumber" id="a195" /></td>
                                                	<td><input value="<? echo $viewdata->a323; ?>" name="a323" type="text" class="span12 onlynumber" id="a196" /></td>
                                                  <td><input value="<? echo $viewdata->a324; ?>" name="a324" type="text" class="span12 onlynumber" id="a197" /></td>
                                              </tr>
                                              <tr>
                                               	  <td colspan="2">Class III</td>
                                                	<td><input value="<? echo $viewdata->a325; ?>" name="a325" type="text" class="span12 onlynumber" id="a198" /></td>
                                                	<td><input value="<? echo $viewdata->a326; ?>" name="a326" type="text" class="span12 onlynumber" id="a199" /></td>
                                                  <td><input value="<? echo $viewdata->a327; ?>" name="a327" type="text" class="span12 onlynumber" id="a200" /></td>
                                              </tr>
                                              <tr>
                                               	  <td colspan="2">Class IV</td>
                                                	<td><input value="<? echo $viewdata->a328; ?>" name="a328" type="text" class="span12 onlynumber" id="a201" /></td>
                                                	<td><input value="<? echo $viewdata->a329; ?>" name="a329" type="text" class="span12 onlynumber" id="a202" /></td>
                                                  <td><input value="<? echo $viewdata->a330; ?>" name="a330" type="text" class="span12 onlynumber" id="a203" /></td>
                                              </tr>
                                          </table>
                               		  </div>
                                      <div class="span11 form-horizontal well">
										...
										<p class="f_legend">
                                        	Status of Human Resources (Class wise)
                                            	<span style="float: right" class="input-append date dp2" data-date-format="yyyy/mm/dd">Reporting date 
                                            	<input id="a832" name="a832" class="span6" type="text" readonly value="<? echo $viewdata->a832; ?>" />
                                                	<span class="add-on">
                                                    	<i class="splashy-calendar_day"></i>
                                                	</span>
                                                </span>                                             
                                          ...
                                          <table class="table table-striped table-bordered">
                                            ...
                                            <tr>
                                              ...
                                              <th>Female</th>
                                                  ...
                                                  <tr>
                                                    <th colspan="5">Upazila Total</th>
                                                  </tr>
                                              </thead>
                                              <tr>
                                               	  <td rowspan="2">Class I</td>
                                               	  <td>Doctor</td>
                                                	<td><input value="<? echo $viewdata->a331; ?>" name="a331" type="text" class="span12 onlynumber" id="a189" /></td>
                                                	<td><input value="<? echo $viewdata->a332; ?>" name="a332" type="text" class="span12 onlynumber" id="a190" /></td>
                                                  <td><input value="<? echo $viewdata->a333; ?>" name="a333" type="text" class="span12 onlynumber" id="a191" /></td>
                                              </tr>
                                              <tr>
                                                <td>Non-Doctor</td>
                                                <td><input value="<? echo $viewdata->a334; ?>" name="a334" type="text" class="span12 onlynumber" id="a192" /></td>
                                                <td><input value="<? echo $viewdata->a335; ?>" name="a335" type="text" class="span12 onlynumber" id="a193" /></td>
                                                <td><input value="<? echo $viewdata->a336; ?>" name="a336" type="text" class="span12 onlynumber" id="a194" /></td>
                                              </tr>
                                              <tr>
                                               	  <td colspan="2">Class II</td>
                                                	<td><input value="<? echo $viewdata->a337; ?>" name="a337" type="text" class="span12 onlynumber" id="a195" /></td>
                                                	<td><input value="<? echo $viewdata->a338; ?>" name="a338" type="text" class="span12 onlynumber" id="a196" /></td>
                                                  <td><input value="<? echo $viewdata->a339; ?>" name="a339" type="text" class="span12 onlynumber" id="a197" /></td>
                                              </tr>
                                              <tr>
                                               	  <td colspan="2">Class III</td>
                                                	<td><input value="<? echo $viewdata->a340; ?>" name="a340" type="text" class="span12 onlynumber" id="a198" /></td>
                                                	<td><input value="<? echo $viewdata->a341; ?>" name="a341" type="text" class="span12 onlynumber" id="a199" /></td>
                                                  <td><input value="<? echo $viewdata->a342; ?>" name="a342" type="text" class="span12 onlynumber" id="a200" /></td>
                                              </tr>
                                              <tr>
                                               	  <td colspan="2">Class IV</td>
                                                	<td><input value="<? echo $viewdata->a343; ?>" name="a343" type="text" class="span12 onlynumber" id="a201" /></td>
                                                	<td><input value="<? echo $viewdata->a344; ?>" name="a344" type="text" class="span12 onlynumber" id="a202" /></td>
                                                  <td><input value="<? echo $viewdata->a345; ?>" name="a345" type="text" class="span12 onlynumber" id="a203" /></td>
                                              </tr>
                                          </table>
                               		  </div>
                                      <div class="span11 form-horizontal well">
										...
										<p class="f_legend">
                                        	Status of Human Resources (Class wise)
                                            	<span style="float: right" class="input-append date dp2" data-date-format="yyyy/mm/dd">Reporting date 
                                            	<input name="a833" type="text" class="span6" id="a833" readonly value="<? echo $viewdata->a833; ?>" />
                                                	<span class="add-on">
                                                    	<i class="splashy-calendar_day"></i>
                                                	</span>
                                                </span>                                             
                                          ...
                                          <table class="table table-striped table-bordered">
                                            ...
                                            <tr>
                                              ...
                                              <th>Female</th>
                                                  ...
                                                  <tr>
                                                    <th colspan="5">Other Hospitals/Facilities</th>
                                                  </tr>
                                              </thead>
                                              <tr>
                                               	  <td rowspan="2">Class I</td>
                                               	  <td>Doctor</td>
                                                	<td><input value="<? echo $viewdata->a346; ?>" name="a346" type="text" class="span12 onlynumber" id="a189" /></td>
                                                	<td><input value="<? echo $viewdata->a347; ?>" name="a347" type="text" class="span12 onlynumber" id="a190" /></td>
                                                  <td><input value="<? echo $viewdata->a348; ?>" name="a348" type="text" class="span12 onlynumber" id="a191" /></td>
                                              </tr>
                                              <tr>
                                                <td>Non-Doctor</td>
                                                <td><input value="<? echo $viewdata->a349; ?>" name="a349" type="text" class="span12 onlynumber" id="a192" /></td>
                                                <td><input value="<? echo $viewdata->a350; ?>" name="a350" type="text" class="span12 onlynumber" id="a193" /></td>
                                                <td><input value="<? echo $viewdata->a351; ?>" name="a351" type="text" class="span12 onlynumber" id="a194" /></td>
                                              </tr>
                                              <tr>
                                               	  <td colspan="2">Class II</td>
                                                	<td><input value="<? echo $viewdata->a352; ?>" name="a352" type="text" class="span12 onlynumber" id="a195" /></td>
                                                	<td><input value="<? echo $viewdata->a353; ?>" name="a353" type="text" class="span12 onlynumber" id="a196" /></td>
                                                  <td><input value="<? echo $viewdata->a354; ?>" name="a354" type="text" class="span12 onlynumber" id="a197" /></td>
                                              </tr>
                                              <tr>
                                               	  <td colspan="2">Class III</td>
                                                	<td><input value="<? echo $viewdata->a355; ?>" name="a355" type="text" class="span12 onlynumber" id="a198" /></td>
                                                	<td><input value="<? echo $viewdata->a356; ?>" name="a356" type="text" class="span12 onlynumber" id="a199" /></td>
                                                  <td><input value="<? echo $viewdata->a357; ?>" name="a357" type="text" class="span12 onlynumber" id="a200" /></td>
                                              </tr>
                                              <tr>
                                               	  <td colspan="2">Class IV</td>
                                                	<td><input value="<? echo $viewdata->a358; ?>" name="a358" type="text" class="span12 onlynumber" id="a201" /></td>
                                                	<td><input value="<? echo $viewdata->a359; ?>" name="a359" type="text" class="span12 onlynumber" id="a202" /></td>
                                                  <td><input value="<? echo $viewdata->a360; ?>" name="a360" type="text" class="span12 onlynumber" id="a203" /></td>
                                              </tr>
                                          </table>
                               		  </div>
										</p>
                                          ...
                                          <table class="table table-striped table-bordered">
                                              <thead>                                                  
                                                  <tr>
                                                    ...
                                                    <th colspan="2">UHC/Upazila Health Office</th>
                                    ...
                                    <div class="tab-pane" id="page_12">
										...
										<p class="f_legend">Data Entry Form for Sadar Upazila Health Office</p>	
                                        <table class="table table-striped table-bordered">
                                        <thead>
                                          <tr>
                                        ...
                                        <div class="span11 form-horizontal well">
                                                ...
                                                <fieldset>
                                                    <p class="f_legend">Important information and necessary issues you want to raise (Year <? echo ($openyear-1); ?>)</p>
                                                            <textarea name="a1100" cols="30" rows="10" class="span12" id="lastcomments_char_limit" placeholder="Maximum 2000 characters"><? echo $viewdata->a1100; ?></textarea>
                                                </fieldset>
