                                    ...
                                    <div class="tab-pane" id="page_5">
                                      ...
                                      <div class="span11 form-horizontal well">
										<div class="alert-error alert">
                                       	  <font size="5"><center><strong>Notice!!! </strong>Please Fill Up the following field</center></font>
                                        </div>
                                      	<div class="alert-error alert">
                                        	 Total Patient days in <span class="heading">Tertiary Hospital</span> in 365 days in <? echo ($openyear-1); ?><hr /><input value="<? echo $viewdata->a1090; ?>" name="a1090" type="text" class="onlynumber span12" id="a1090" />
                                        </div>
                                        <div class="alert-error alert">
