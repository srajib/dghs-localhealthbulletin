           ...
           <div id="contentwrapper">
                <div class="main_content">
                  <?php include "_nav.php"; ?>
					<div class="row-fluid">
						<div class="span12">               	                    
							<h3 class="heading">Data Entry Form for Upazila Health Complex <?php echo $msg; ?>
                            </h3>
                           	<div class="tabbable tabs-left">
								<ul class="nav nav-tabs">
                                    ...
                                    <li><a href="#page_9" data-toggle="tab" class="pop_over" data-original-title="Surgeries & Interventions done in the UHC" data-placement="right">Page 9</a></li>
									<li><a href="#page_10" data-toggle="tab" class="pop_over" data-original-title="Class wise Manpower in the UHC" data-placement="right">Page 10</a></li>
									...
									<li><a href="#page_12" data-toggle="tab" class="pop_over" data-original-title="Existing equipments at UHC" data-placement="right">Page 12</a></li>                                    																																																									 									<li><a href="#page_13" data-toggle="tab" class="pop_over" data-original-title="Additional Information" data-placement="right">Page 13</a></li>
                                ...
                                <div class="tab-content">
                                      ...
                                      <div class="span11 form-horizontal well">
										...
										<p class="f_legend">Maternal health &amp; MDG-5 (Year <? echo ($openyear-1); ?>) </p>	
                                          <table class="table table-striped table-bordered">
                                              ...
                                              <tr>
                                               	  <td><p>No. of forceps deliveries</p></td>
                                    ...
                                    <div class="tab-pane" id="page_5">
										<p>
                                      <div class="span11 form-horizontal well">
                                      	<div class="alert-error alert" style="text-decoration: blink">
                                       	  <font size="5"><center>
                                       	    <strong>Notice!!! </strong>Please Fill Up the following four fields
                                       	  </center></font>
                                        </div>
                                      	<div class="alert-error alert">
                                        	 Total Patient days in Upazila Health Complex in 365 days in <? echo ($openyear-1); ?><hr /><input value="<? echo $viewdata->a1090; ?>" name="a1090" type="text" class="onlynumber span12" id="a1090" />
                                        </div>
                                        <div class="alert-error alert">
                                        	 Bed Occupacy rate in <? echo ($openyear-1); ?>
                                        	 <hr /><input value="<? echo number_format($viewdata->a1091,2); ?>" name="a1091" type="text" class="span12" id="a1090" />
                                        </div>
                                        <div class="alert-error alert">
                                        	 Average Length of Hospital Stay <? echo ($openyear-1); ?>
                                        	 <hr /><input value="<? echo number_format($viewdata->a1092,2); ?>" name="a1092" type="text" class="span12" id="a1090" />
                                        </div>
                                        <div class="alert-error alert">
                                        	 Hospital Death Rate <? echo ($openyear-1); ?>
                                        	 <hr /><input value="<? echo number_format($viewdata->a1093,2); ?>" name="a1093" type="text" class="span12" id="a1090" />
                                        </div>                                        
										<hr />                                        	
...
<p>The classification of major or minor for each proposed surgical procedure will be determined by the IACUC committee.</p>
                          ...
                          <tr>
                                          ...
                                          <table class="table table-striped table-bordered">
                                            ...
                                            <tr>
                                              ...
                                              <th>Female</th>
                                                  ...
                                                  <tr>
                                                    <th colspan="5">Union Sub Centers (USC)</th>
                                                  </tr>
                                              </thead>
                                              <tr>
                                               	  <td rowspan="2">Class I</td>
                                    ...
                                    <div class="tab-pane" id="page_12">
										...
										<p class="f_legend">Data Entry Form for Upazila Health Complex</p>	
                                        <table class="table table-striped table-bordered">
                                        <thead>
                                          <tr>
                                          ...
                                          <tr>
                                            ...
                                            <tr>
                                              ...
                                              <tr>
                                                <td>Mobile phone</td>
                                                <td><input value="<? echo $viewdata->a803; ?>" name="a803" type="text" class="span12 onlynumber" id="a327" /></td>
