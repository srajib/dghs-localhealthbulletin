   ...
   <fieldset>
    ...
    <table width="100%" border="1" align="center" cellspacing="0">
      ...
      <tr>
        ...
        <td id="tblclm2"><?php echo number_format($pdfdata->a847+$pdfdata->a137+$pdfdata->a140+$pdfdata->a143+$pdfdata->a146+$pdfdata->a149+$pdfdata->a152+$pdfdata->a154+$pdfdata->a157+$pdfdata->a160+$pdfdata->a163); ?></td>
      </tr>
      </tbody>
    </table>
    </fieldset>
    <fieldset>
        <legend>
        <div id="lgndp">No. of Admissions &amp; Deaths at Civil Surgeon Office</div></legend>
        <table width="100%" border="1" align="center" cellspacing="0">
      <tbody><tr>
        <td width="36%" rowspan="2" id="tblhdp">Health Facility</td>
    ...
    <table width="100%" border="1" align="center" cellspacing="0">
      ...
      <tr>
        ...
        <td id="tblclm2"><?php echo number_format(($pdfdata->a233/$pdfdata->a225)*10,2); ?></td>
        </tr>
      <tr>
    ...
    <table width="100%" border="1" align="center" cellspacing="0">
      ...
      <tr>
        ...
        <td id="tblclm2"><? echo round(($pdfdata->a854-($pdfdata->a855+$pdfdata->a856))/($pdfdata->a854)*100,2); ?>  </td>
      </tr>
      <tr>
        ...
        <td id="tblclm2"><? echo round(($pdfdata->a857-($pdfdata->a858+$pdfdata->a859))/($pdfdata->a857)*100,2); ?></td>
        </tr>
      <tr>
        ...
        <td id="tblclm2"><? echo ($pdfdata->a860-($pdfdata->a861+$pdfdata->a862)); ?></td>
        <td id="tblclm2"><? echo round(($pdfdata->a860-($pdfdata->a861+$pdfdata->a862))/($pdfdata->a860)*100,2); ?></td>
      </tr>
      <tr>
        ...
        <td id="tblclm2"><? echo round(($pdfdata->a863-($pdfdata->a864+$pdfdata->a865))/($pdfdata->a863)*100,2); ?></td>
        </tr>
      <tr>
        ...
        <td id="tblclm2"><? echo round(($pdfdata->a866-($pdfdata->a867+$pdfdata->a868))/($pdfdata->a868)*100,2); ?></td>
      </tr>
	</tbody></table>
    </fieldset>
    </div>
