           ...
           <div id="contentwrapper">
                <div class="main_content">
                  <?php include "_nav.php"; ?>
					<div class="row-fluid">
						<div class="span12">               	                    
							<h3 class="heading">Data Entry Form for District/General Hospital<?php echo $msg; ?>
                            </h3>
                           	<div class="tabbable tabs-left">
								<ul class="nav nav-tabs">
                                    ...
                                    <li><a href="#page_9" data-toggle="tab" class="pop_over" data-original-title="Surgeries & Interventions done in the District/General Hospital" data-placement="right">Page 9</a></li>
									<li><a href="#page_10" data-toggle="tab" class="pop_over" data-original-title="Class wise Manpower in the District/General Hospital" data-placement="right">Page 10</a></li>
									...
									<li><a href="#page_12" data-toggle="tab" class="pop_over" data-original-title="Existing equipments at District/General Hospital" data-placement="right">Page 12</a></li>                                    																																																									 									<li><a href="#page_13" data-toggle="tab" class="pop_over" data-original-title="Additional Information" data-placement="right">Page 13</a></li>
									...
									<div class="tab-pane" id="page_1">
                                        ...
                                        <div class="span11 form-horizontal well">
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="control-group">
                                                        <label class="control-label">Name of Superintendent</label>
                                                        <div class="controls">
                                                    ...
                                                    <div class="control-group">
                                                        <label class="control-label">GPS Location of Hospital</label>
                                                        <div class="controls">
                                      ...
                                      <div class="span11 form-horizontal well">
										<div class="alert-error alert" style="text-decoration: blink">
                                      	...
                                      	<div class="alert-error alert">
                                        	 Total Patient days in District/General Hospital in 365 days in <? echo ($openyear-1); ?><hr /><input value="<? echo $viewdata->a1090; ?>" name="a1090" type="text" class="onlynumber span12" id="a1090" />
                                        </div>
                                        <div class="alert-error alert">
                                          ...
                                          <table class="table table-striped table-bordered">
                                              <thead>                                                  
                                                  <tr>
                                                    ...
                                                    <th colspan="2">Hospital Total</th>
                                        ...
                                        <thead>
                                          ...
                                          <tr>
                                            ...
                                            <th>Non-Repairable (No.)</th>
                                                ...
                                                <tr>
                                                  <th colspan="5">Current Status of equipment at Hospital</th>
                                                </tr>
