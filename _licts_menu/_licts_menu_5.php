										...
										<div class="accordion-body collapse" id="collapseTwo">
											<div class="accordion-inner">
												<ul class="nav nav-list">
													...
													?>
													<li>
													<a href="./publish/publish.php?org=<? echo $orgid; ?>&year=<?echo $year_pub->year_;?>" target="_blank"><? echo $year_pub->year_; ?></a>
													</li>
													<? } ?>
                                                    <li><a href="http://app.dghs.gov.bd/lhb/reportbyadmin.php?yid=2012&lvl=3&om=<? echo $orgemail; ?>&oti=&organame=<? echo $org_details->name; ?>">2012</a></li>
												</ul>
											</div>
										</div>
									</div>
